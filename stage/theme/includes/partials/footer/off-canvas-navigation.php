			   ...
			   <div class="off-canvas-menu-container mobile-only">
					  ...
					  <ul class="menu">
						...
						<?php if ( is_user_logged_in() ) : ?>
							<li  class="logout-button-mob">
								<a style="color: #d7b357 !important" href="<?php echo wp_logout_url( get_permalink() ); ?>"><?php echo __('LOG OUT', 'salient'); ?></a>
							</li>
						<?php else: ?>
							<li class="login-button-mob">
								<a style="color: #d7b357 !important" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') )?>"><?php echo __('LOGIN', 'salient'); ?></a>
							</li>
						<? endif; ?>
					...
					<?php
						...
						if ( ! empty( $options['secondary-header-text'] ) && $using_secondary == 'header_with_secondary' ) {
							...
							echo '<div class="secondary-header-text kat">';
							if ( ! empty( $nectar_secondary_link ) ) {
								echo '<a href="' . esc_url( $nectar_secondary_link ) . '" target="_blank">'; }
