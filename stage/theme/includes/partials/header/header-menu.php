					...
					<li class="login-button menu-item menu-item-type-custom menu-item-object-custom">
						...
						<div class="login-button_dr custom-login-wrapper">
							<form name="loginform" id="loginform" class="woocommerce-form woocommerce-form-login login loginform-page" method="post">
								...
								<p><label for="username" style="display:none;">username</label><input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" placeholder="<?php esc_html_e( 'Email', 'woocommerce' ); ?> *"/><?php // @codingStandardsIgnoreLine ?></p>
								<p><label for="password" style="display:none;">password</label><input class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="password" id="password" autocomplete="current-password" placeholder="<?php esc_html_e( 'Password', 'woocommerce' ); ?> *" /></p>
