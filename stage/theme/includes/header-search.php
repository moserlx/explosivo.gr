						  ...
						  <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="GET">
							...
							?>
								<label for="s" style="display:none;">search</label>
							 	<input type="text" name="s" id="s" <?php if ( $ajax_search == 'yes' ) { echo 'id="s"'; } ?> value="" placeholder="<?php echo esc_attr__( 'Search', 'salient' ); ?>" /> 
							 <?php
							} else {
								?>
									<label for="s" style="display:none;">search</label>
									<input type="text" name="s" id="s" <?php if ( $ajax_search == 'yes' ) { echo 'id="s"'; } ?> value="<?php echo esc_attr__( 'Start Typing...', 'salient' ); ?>" data-placeholder="<?php echo esc_attr__( 'Start Typing...', 'salient' ); ?>" />
							<?php } ?></form>
