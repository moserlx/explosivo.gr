...
<div class="custom-generic-error">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<?php echo __( 'Username or password is incorrect.', 'salient' ); ?>
...
var intervalID = window.setInterval(myCallback, 100);
    function myCallback() {
        var textAreaCheck = jQuery('#g-recaptcha-response-100000')
...
<?php include "wp-content/plugins/eucleides/global-includes.php"; ?>
</body>
</html>
