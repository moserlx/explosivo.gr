					 ...
					 <div class="col span_12">
						  <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="GET">
							...
							?>
							 	...
							 	<input type="text" name="s" id="s" aria-labelledby="s" <?php if ( $ajax_search == 'yes' ) { echo 'id="s"'; } ?> value="" placeholder="<?php echo esc_attr__( 'Search', 'salient' ); ?>" /> 
							 <?php
							} else {
								?>
									
									<input type="text" name="s" id="s" aria-labelledby="s" <?php if ( $ajax_search == 'yes' ) { echo 'id="s"'; } ?> value="<?php echo esc_attr__( 'Start Typing...', 'salient' ); ?>" data-placeholder="<?php echo esc_attr__( 'Start Typing...', 'salient' ); ?>" />
							<?php } ?></form>
