	  ...
	  <div class="col span_7 col_last">
		<ul class="social">
			...
			if ( ! empty( $options['use-twitter-icon'] ) && $options['use-twitter-icon'] == 1 ) {
				?>
			   <li><a target="_blank" href="<?php echo esc_url( $options['twitter-url'] ); ?>"><i class="fa fa-twitter"></i> <span style="display:none;">twitter</span> </a></li> <?php } ?>
		  <?php
			if ( ! empty( $options['use-facebook-icon'] ) && $options['use-facebook-icon'] == 1 ) {
				?>
			 <li><a target="_blank" href="<?php echo esc_url( $options['facebook-url'] ); ?>"><i class="fa fa-facebook"></i> <span style="display:none;">facebook</span> </a></li> <?php } ?>
		  <?php
		  ...
		  <?php
			if ( ! empty( $options['use-youtube-icon'] ) && $options['use-youtube-icon'] == 1 ) {
				?>
			 <li><a target="_blank" href="<?php echo esc_url( $options['youtube-url'] ); ?>"><i class="fa fa-youtube-play"></i> <span style="display:none;">youtube</span></a></li> <?php } ?>
		  <?php
		  ...
		  <?php
			if ( ! empty( $options['use-instagram-icon'] ) && $options['use-instagram-icon'] == 1 ) {
				?>
			 <li><a target="_blank" href="<?php echo esc_url( $options['instagram-url'] ); ?>"><i class="fa fa-instagram"></i><span style="display:none;">instagram</span></a></li> <?php } ?>
		  <?php
